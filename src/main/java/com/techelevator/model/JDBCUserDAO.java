...
public class JDBCUserDAO implements UserDAO {
	...
	public void saveUser(String userName, String password, String role, String emailAddress, String firstName, String lastName) {
		...
		jdbcTemplate.update("INSERT INTO app_user(user_name, password, role, salt, email, f_name, l_name) VALUES (?, ?, ?, ?, ?, ?, ?)",
				userName, hashedPassword, role, saltString, emailAddress, firstName, lastName);
	}
	...
	public void updateUserRole(String username) {
		String sqlUpdateUserRole = "UPDATE app_user SET role = 'Premium' WHERE user_name = ?; ";
		
		jdbcTemplate.update(sqlUpdateUserRole, username);
	}
	...
	public void createDefaultCollection(String username) {
		jdbcTemplate.update("INSERT INTO collection(user_name, collection_name, access_type) "
						+ "VALUES (?, ?, ?);", username, "Default Collection", "Public");
	}
	public void createDefaultWishList(String username) { 
		jdbcTemplate.update("INSERT INTO wishlist(user_name, wishlist_name) " +
							"VALUES (?, ?);", username, "My WishList");
	}
}
